...
public class MoveToTarget3 : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      //  }
        ...
        {
            float step = speed * Time.deltaTime;
            transform.position = Vector3.MoveTowards(transform.position, fixorigin.position, step);
            // Determine which direction to rotate towards
            Vector3 targetDirection = fixorigin.forward;
